...
for(jjj in 1:rpnum){
  ...
  # Load Data: Two Outliers

  z_xubb=z_uubb=z_xub[,,indexb[,jjj]]
  yboot=array(bigy2[,,,jjj],c(12,1,252))
  ...
  paresm2[,,jjj]=rbind(est_L$pr.theta,est_L$beta.theta)
 }


 fLname=paste0("C:\\Users\\weixing\\Dropbox\\LmmSimul\\","L-RealData-2.Rdata")
 save(paresm2,file=fLname)
