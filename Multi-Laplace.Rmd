---
title: "Mixture of LMM Using Multivaraite Laplace Distribution"
author: "Weixing Song"
date: "2024-08-24"
output: pdf_document
---
...
This is the one of three R Programs developed for the paper *Robust Mixture of Linear Mixed Modeling via Multivariate Laplace Distribution*. The estimation method is based upon the multivariate Laplace-distribution, by Song, Bai and Li.\vskip 0.1in
...
## Functions Used in EM-Laplace Algorightm
...
I=100   # total subject
datatype="N" # N, T1, T3, T5, Laplace, CN
...
{ # start the repetition loop;
  ...
  est_L=LMIX_LMM(z_yub=z_yub,z_xub=z_xub, z_uub=z_uub,pr.init=pr.init,
...
time1-time0
```
# Reporting the simulation result
